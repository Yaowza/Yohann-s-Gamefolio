---
title: "Black Hole Explosion VFX"
summary: "A Black Hole explosion vfx I made for myself."
categories: ["vfx"]
...
{{< youtubeLite id="mEMqbkaouH0" label=" VFX_Black Hole Star Explosion with sound " >}}


This was originally an exercise given to the tech artists. They had to create a VFX from scratch with a good rythm. It needed a slow intro, a peak and an outro that is not just a simple fade.

<div style="height: 70px;"></div> 

<div class="text-center w-full">
<h2>\\\Breakdown Comming Soon///</h2>
</div>